...
(function ($, huawei) {
    ...
    huawei.changePasswordForm =
    function () {
        $(".js-personal-information")
        .off("submit").on("submit", function (e) {

            if (!$(this).validate().form()) {
                return false;
            }
            //$(".js-personal-information-form-submit").attr("disabled", "disabled");
            $(this).ajaxSubmit({
                beforeSubmit: function () {
                    /*OpenLoadingNew($("#Msgload").val());*/
                ...
                success: function (data) {
                    ...
                    if (data.ackCode == 1) {
                        ...
                        if (hidAppUrl != "" && hidAppUrl != undefined) {
                            ...
                            if (ret.exec(hidAppUrl) == "?") {
                                hidAppUrl = hidAppUrl + "&userid=" + data.uid;
                            }
                            else {
                                hidAppUrl = hidAppUrl + "?userid=" + data.uid;
                            }
                    ...
                    //$(".js-personal-information-form-submit").removeAttr("disabled");
                    return false;
                }
            });
            return false;
        ...
        .validate({
            ...
            messages: {
                ...
                User: {
                    remote: 'Email already exist, if you forget the password, <a href="#" class="bule">click here</a> to reset it.'
                },
                LoginPassword: {
                    remote: 'Email already exist, if you forget the password, <a href="#" class="bule">click here</a> to reset it.'
                },
            ...
            $(".js_subscribe_form")
                ...
                .validate({
                    ...
                    messages: {
                        ...
                        "value(Department)": {
                            required: '<i class="icon_error"></i>御所属を入力してください'
                        },
                        "value(Email)": {
